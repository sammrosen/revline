...
// GET /api/v1/admin/clients/[id] - Get client details with events
...
// PATCH /api/v1/admin/clients/[id] - Update client (pause/unpause)
...
// DELETE /api/v1/admin/clients/[id] - Delete client (cascade deletes integrations, leads, events)
