...
// GET /api/v1/admin/workspaces/[id] - Get client details with events
...
// PATCH /api/v1/admin/workspaces/[id] - Update client (pause/unpause)
...
// DELETE /api/v1/admin/workspaces/[id] - Delete client (cascade deletes integrations, leads, events)
